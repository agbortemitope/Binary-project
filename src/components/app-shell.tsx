...
export function AppShell({
  ...
  const showWorkspaceHeader = currentPath === "/lead" || currentPath === "/worker";
      ...
      <div className="relative min-w-0">
        ...
        <div className="px-1 lg:px-0">
          <div className="rounded-[28px] p-0 sm:p-2 lg:glass-card lg:rounded-[32px] lg:border lg:border-white/70 lg:p-6 lg:shadow-[0_24px_64px_rgba(20,33,61,0.12)]">
            ...
            <div className={cn("pb-[calc(env(safe-area-inset-bottom)+5.5rem)] lg:pb-0", showWorkspaceHeader ? "lg:mt-5" : "")}>
              {children}
            </div>
          </div>
        </div>
