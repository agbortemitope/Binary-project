...
export default async function LeadTeamsPage() {
  ...
  return (
    <div className="grid gap-5 xl:grid-cols-[1.1fr_0.9fr]">
      ...
      <SectionCard>
        <div>
          <p className="text-lg font-bold text-slate-950">Create a team</p>
          <p className="text-sm text-slate-600">Set the payout mode and threshold now. You can keep working in NGN-only for launch.</p>
        </div>
        <div className="mt-4">
          <CreateTeamForm />
        </div>
